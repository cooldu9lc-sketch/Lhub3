<h2><a href="https://leetcode.com/problems/merge-triplets-to-form-target-triplet/solutions/1268471/python-why-greedy-works-here-explained-b-n2jo/?envType=problem-list-v2&envId=plakya4j">1899. Merge Triplets to Form Target Triplet</a></h2><h3>Medium</h3><hr><p>A <strong>triplet</strong> is an array of three integers. You are given a 2D integer array <code>triplets</code>, where <code>triplets[i] = [a<sub>i</sub>, b<sub>i</sub>, c<sub>i</sub>]</code> describes the <code>i<sup>th</sup></code> <strong>triplet</strong>. You are also given an integer array <code>target = [x, y, z]</code> that describes the <strong>triplet</strong> you want to obtain.</p>
